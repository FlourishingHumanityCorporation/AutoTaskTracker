...
class TestDocumentationHealth:
    ...
    def test_no_process_documentation(self):
        ...
        for doc_path in self.get_all_docs():
            ...
            if process_indicators > 0 and process_indicators / total_indicators > 0.3:
                process_docs.append(
        ...
        if process_docs:
            print(f"\n⚠️  Potential process documentation (review for deletion):")
...
def main():
    ...
    tests = [
        ...
        ("No completion/status docs", test.test_no_completion_status_docs),
        ("No process documentation", test.test_no_process_documentation),
