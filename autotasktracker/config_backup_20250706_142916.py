...
class Config:
    ...
    def DB_PATH(self) -> str:
        """Legacy property for database path."""
        return self.DATABASE_URL
    
    @property
    def POSTGRESQL_URL(self) -> str:
        """Legacy property for PostgreSQL URL."""
        return self.DATABASE_URL
    
    # SQLite Fallback Database
    SQLITE_PATH: str = "~/.memos/database.db"
    
    @property
    def SQLITE_URL(self) -> str:
        """Fallback SQLite database URL."""
        return f"sqlite:///{os.path.expanduser(self.SQLITE_PATH)}"
    ...
    # Base directories
    MEMOS_DIR: str = "~/.memos"
    SCREENSHOTS_DIR: str = "~/.memos/screenshots"
    LOGS_DIR: str = "~/.memos/logs"
    CACHE_DIR: str = "~/.memos/cache"
    VLM_CACHE_DIR: str = "~/.memos/vlm_cache"
    EMBEDDINGS_CACHE_DIR: str = "~/.memos/embeddings_cache"
    TEMP_DIR: str = "~/.memos/temp"
    
    # Configuration files
    PENSIEVE_CONFIG_FILE: str = "~/.memos/config_autotasktracker.yaml"
    AUTOTASK_CONFIG_FILE: str = "~/.memos/autotask_config.json"
    
    # ============================================================================
    # SERVER PORTS - AUTOTASKTRACKER RANGE (8600-8699)
    # ============================================================================
    ...
    # Additional Dashboard Ports (found in codebase)
    ...
    # Pensieve/Memos Services
    MEMOS_PORT: int = 8841          # Pensieve API (AutoTaskTracker)
    MEMOS_WEB_PORT: int = 8842      # Pensieve Web UI (AutoTaskTracker)
    
    # AI Services
    OLLAMA_PORT: int = 11434        # Ollama (VLM + Embeddings)
    OCR_SERVICE_PORT: int = 5555    # OCR Service
    
    # Development Services
    JUPYTER_PORT: int = 8888        # Jupyter Notebook
    TENSORBOARD_PORT: int = 6006    # TensorBoard
    ...
    def _get_pensieve_path(self, default_path: str, config_key: str) -> str:
        ...
        # Disabled to prevent recursion - just use default path
        return os.path.expanduser(default_path)
    
    @property
    def SCREENSHOTS_DIR_PROPERTY(self) -> str:
        """Dynamic screenshots directory with Pensieve sync."""
        return self._get_pensieve_path(self.SCREENSHOTS_DIR, "screenshots_dir")
    
    @property
    def LOGS_DIR_PROPERTY(self) -> str:
        """Dynamic logs directory with Pensieve sync."""
        return self._get_pensieve_path(self.LOGS_DIR, "logs_dir")
    
    @property
    def VLM_CACHE_DIR_PROPERTY(self) -> str:
        """Dynamic VLM cache directory with Pensieve sync."""
        return self._get_pensieve_path(self.VLM_CACHE_DIR, "cache_dir")
    ...
    def get_database_url(self) -> str:
        """Get database URL."""
        return _validate_path_security(self.DATABASE_URL)
...
# Global instance
_central_config: Optional[Config] = None


def get_central_config() -> Config:
    """Get the global central configuration instance."""
